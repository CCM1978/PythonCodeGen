...
net = tflearn.input_data(shape=[None, len(training[0])])  # Define input shape for our model
...
net = tflearn.regression(net)  # Apply regression on model
...
if answer == 'P':
  ...
  # Ask for symptom
  breathing_issue = input("Do you have short breathing or other breathing issues? (Yes or No) ")
  ...
  if infected:
    print("I highly suggest you to do a COVID-19 test.")
  else:
    print("There is a large chance that you did not get COVID-19, drink some water and get some sleep.")
